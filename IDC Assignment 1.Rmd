...
#Briefly sense check this model using graphs

plot(fitreco$fitted.values,residuals(fitreco), xlab = "Fitted values", ylab = "Residuals")
qqnorm(rstandard(fitreco))
qqline(rstandard(fitreco),col=2)
