...
#Remove all NA values from the recovtime data set
comp = which(is.na(databp$recovtime) == FALSE)
...
cor(x = databp$recovtime, y = databp$longdose, use="complete.obs", method="pearson")
